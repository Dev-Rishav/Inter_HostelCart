  ...
  <div class="container mx-12 px-1 py-12">
    <div class="flex flex-wrap -mx-4">
      ...
      <div class="w-full md:w-1/2 px-14">
        ...
        <div class="mb-4">
          <span class="text-2xl font-bold mr-2"> $ {item.price}</span>
          <span class=" ml-6 text-lg font-semibold">Listing Date :{item.date}</span>
        </div>
        
        <p class="text-gray-700 mb-6"> {item.detail}</p>
