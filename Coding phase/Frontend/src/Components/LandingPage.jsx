...
<div class="relative mb-6">
    ...
    <span class="text-[10px] text-gray-500 dark:text-gray-400 absolute start-0 -bottom-6">Min (₹100)</span>
    <span class="text-[10px] text-gray-500 dark:text-gray-400 absolute start-1/3 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6">₹500</span>
    <span class="text-[10px] text-gray-500 dark:text-gray-400 absolute start-2/3 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6">₹1000</span>
    <span class="text-[10px] text-gray-500 dark:text-gray-400 absolute end-0 -bottom-6">Max (₹1500)</span>
</div>
