      ...
      <div className="mx-auto">
        ...
        <div className="flex justify-between items-center px-20 py-4 border-t border-b border-gray-200">
          ...
          <div className="flex items-center space-x-4">
            ...
            {showMenu && (
              <div className="fixed top-14 right-16 w- mr-5 rounded-xl z-30 bg-gray-200 shadow-md p-6">
                <ul>
                  <li>
                    <NavLink to="/profile" className="block py-2 px-4 hover:bg-gray-100">
                      Profile
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/additem" className="block py-2 px-4 hover:bg-gray-100">
                      Add Item
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/payment" className="block py-2 px-4 hover:bg-gray-100">
                      Payment
                    </NavLink>
                  </li>
                </ul>
